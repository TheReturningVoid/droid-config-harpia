# DisplayName: Jolla harpia/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: harpia
# DeviceVariant: harpia
...
repo --name=adaptation-community-common-harpia-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration harpia
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/harpia
